...
int main (int argc, char *argv[])
{
	...
	/*add box*/
	gtk_container_add( GTK_CONTAINER(main_win), menu_box );
	...
	exit_entry = gtk_menu_item_new_with_label( "Exit" );
	...
	/*pack menu*/
	gtk_box_pack_start( GTK_BOX(menu_box), menubar, FALSE, FALSE, 3 );
